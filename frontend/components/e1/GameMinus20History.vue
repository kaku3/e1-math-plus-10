...
export default Vue.extend({
  ...
  computed: {
    ...
    sprint10Scores(): ScoreEntity[] {
      return this.termFilteredScoreEntities('minusSprint-10')
    },
    sprint30Scores(): ScoreEntity[] {
      return this.termFilteredScoreEntities('minusSprint-30')
    },
    endressScores(): ScoreEntity[] {
      return this.termFilteredScoreEntities('minusEndress')
    },
