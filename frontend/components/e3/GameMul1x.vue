        ...
        <v-row class="ex-canvas text-center">
          <v-col cols="12" align-self="center">
            <v-btn
              ...
              @click="goGameIndex()"
            >
              <v-icon>mdi-playlist-edit</v-icon>かけざん１ｘ
            </v-btn>
            <v-btn
              x-large
              color="blue"
...
export default Vue.extend({
  ...
  methods: {
    ...
    next() {
      ...
      this.answer = 0
      this.question1 = Math.floor(Math.random() * 10) + 10
      this.question2 = Math.floor(Math.random() * 10) + 10
  ...
  computed: {
    ...
    isSprint(): boolean {
      return this.gameMode === 'mul1xSprint'
    },
    isEndress(): boolean {
      return this.gameMode === 'mul1xEndress'
    },
    displayScore(): number {
      return this.gameMode === 'mul1xSprint' ? this.score : this.score2
    },
