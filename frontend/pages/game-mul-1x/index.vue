<template>
  <div>
    ...
    <GameMul1xHistory class="mt-2" :gameMode="gameMode" :questionCount="questionCount" />
    <Chat room="all" />
...
import GameMul1xHistory from '~/components/e3/GameMul1xHistory.vue'
...
export default Vue.extend({
  ...
  async asyncData({ $content, params}) {
    console.log(params)
    const textBook = await $content('e3/mul1x').fetch()
